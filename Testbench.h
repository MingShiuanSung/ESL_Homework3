...
public:
	...
	sc_out < bool >  o_rst;
#ifndef NATIVE_SYSTEMC
	cynw_p2p< sc_dt::sc_uint<24> >::base_out o_rgb; // char rgb
	cynw_p2p< sc_dt::sc_uint<24> >::base_in i_rgb; // double rgb
#else
	sc_fifo_out< sc_dt::sc_uint<24> > o_rgb; // char rgb
	sc_fifo_in< sc_dt::sc_uint<24> > i_rgb; // double rgb
#endif
